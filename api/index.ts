...
import webhook from '../lib/routes/webhook';
import account from '../lib/routes/account';
import notifications from '../lib/routes/notifications';
...
const routes: Record<string, Handler> = {
  ...
  dashboard, 'api-key-regenerate': apiKeyRegenerate, webhook, account,
  notifications, 'app-status': appStatus, 'invoice-detail': invoiceDetail,
  'public-payment-status': publicPaymentStatus, 'finance-report': financeReport,
};
